...
SECRET_KEY = 'django-insecure-kc_*_6naeu0q)de)$vui_2kcw07)*+8(o45zdr5otf^=_amozv'
...
TEMPLATES = [
    {
        ...
        'DIRS': [(os.path.join(BASE_DIR, 'zaverecne_zadanie/templates'))]
        ,
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
                ...
                'zaverecne_zadanie.context_processors.context_processors.trans_context',
            ],
        },
    },
]
